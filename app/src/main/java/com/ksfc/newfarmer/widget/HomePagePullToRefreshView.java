...
public class HomePagePullToRefreshView extends LinearLayout {
	...
	public HomePagePullToRefreshView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		init();
	}

	public HomePagePullToRefreshView(Context context) {
		super(context);
		this.context = context;
		init();
	}
	...
	public interface OnFooterRefreshListener {
		public void onFooterRefresh(HomePagePullToRefreshView view);
	}
	...
	public interface OnHeaderRefreshListener {
		public void onHeaderRefresh(HomePagePullToRefreshView view);
	}
