...
public class CustomDialogForHead extends Dialog {

    public CustomDialogForHead(Context context) {
        super(context);
    }

    public CustomDialogForHead(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        public CustomDialogForHead create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final CustomDialogForHead dialog = new CustomDialogForHead(context,
                    R.style.MyAlertDialog);
            View layout = inflater.inflate(R.layout.dialog_new_layout_head, null);
