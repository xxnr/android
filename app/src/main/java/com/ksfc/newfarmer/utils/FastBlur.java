...
public class FastBlur {
    ...
    public static Bitmap doBlur(Bitmap sentBitmap, int radius, boolean canReuseInBitmap,int transparent) {
        ...
        transparent = transparent * 255 / 100;

        for (int j = 0; j < argb.length; j++) {
            argb[i] = (transparent << 24) | (argb[i] & 0x00FFFFFF);
        }
